  ...
  return (
    <div className="min-h-full-nonav mx-0">
      ...
      <div className="relative">
        <img src="/Images/placeholder.png" alt="" className="w-[20rem] md:w-[36rem] aspect-[16/9] object-cover absolute left-2/4 -translate-x-2/4 top-2 md:-top-24 -translate-y-2/4" />
        ...
        <div className="flex content-center items-center max-lg:flex-wrap flex-row mx-20 md:mx-40 gap-4 mb-8">
          ...
          <div className="w-full h-full pb-2 bg-green grow sm:basis-1/3 md:basis-1/4 lg:basis-1/5">
            <img src="/Images/placeholder.png" alt="" className="w-full aspect-[4/3] object-cover overflow-hidden transition-transform ease-in-out delay-100 hover:scale-110" />
